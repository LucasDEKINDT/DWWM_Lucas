...
class UtilisateurManager extends Model{
    ...
    public function getUtilisateurById($Idutilisateur){
        $req = $this->getBdd()->prepare("SELECT * FROM utilisateur WHERE IdUtilisateur = :IdUtilisateur");
        ...
        return new Utilisateur($utilisateur['IdUtilisateur'], $utilisateur['Grade'], $utilisateur['NomUtilisateur'], $utilisateur['PrenomUtilisateur'], $utilisateur['EmailUtilisateur'], $utilisateur['MotDePasse']);
    }
