                ...
                <div class="col ">
                    <div class="card bg-warning text-dark ">
                        <div class="card-body">
                            ...
                            <p class="card-text pt-4">This is a longer card with supporting text below as a natural
                                lead-in to additional content. This content is a little bit longer.</p>
                            <a href="./REGEX/Page d'authetification.php" class="btn btn-outline-light mb-5">page a</a>
                        </div>
                    </div>
                </div>
                <div class="col ">
                ...
                <div class="col ">
                    <div class="card bg-light text-dark ">
                        <div class="card-body">
                            ...
                            <p class="card-text pt-4">This is a longer card with supporting text below as a natural
                                lead-in to additional content. This content is a little bit longer.</p>
                            <a href="./traducteur/traducteur.php" class="btn btn-outline-dark mb-5">look at the ranking</a>
                        </div>
                    </div>
                </div>
            </div>
